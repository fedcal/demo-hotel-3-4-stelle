...
const SLUG = 'hotel-3-4-stelle';
const TITLE = 'Demo Hotel 3-4 stelle — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Hotel 3-4 stelle.',
  base: `/federico-demo-${SLUG}/`,
  cleanUrls: true,
  lang: 'it-IT',

  themeConfig: {
    siteTitle: 'Demo Hotel 3-4 stelle',
