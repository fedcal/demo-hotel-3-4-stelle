...
hero:
  name: "Demo Hotel 3-4 stelle"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://hotel-3-4-stelle.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-hotel-3-4-stelle
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Hotel 3-4 stelle.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Hotel 3-4 stelle** in Italia.
...
Il mercato italiano delle PMI per **Hotel 3-4 stelle** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:hotel-3-4-stelle
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-hotel-3-4-stelle)
