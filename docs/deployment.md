...
URL: `https://hotel-3-4-stelle.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `hotel-3-4-stelle.demo.federicocalo.dev`
...
- Output directory: `dist/hotel-3-4-stelle/browser`
...
URL: `https://fedcal.github.io/federico-demo-hotel-3-4-stelle/`
...
- `base: /federico-demo-hotel-3-4-stelle/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `hotel-3-4-stelle-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   hotel-3-4-stelle-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `hotel-3-4-stelle-docs.federicocalo.dev`
